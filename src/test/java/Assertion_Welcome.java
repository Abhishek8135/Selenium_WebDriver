...
public class Assertion_Welcome {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public void testWelcomePageBehavior() throws InterruptedException {
        ...
        Assert.assertEquals(actualMessage, "Welcome!!", "Message header does not match!");
        ...
        Assert.assertFalse(isFieldEnabledInitially, "Text field was expected to be disabled initially!");
        ...
        Assert.assertTrue(isFieldEnabledAfterClick, "Text field was expected to be enabled after clicking the button!");
    }
